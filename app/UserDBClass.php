...
備考：各SQL文をセットで用意
*/
class UserDBConnect extends FormDBConnect {
...
public function userCreate(array $posted) : object {
  ...
  */
  public function userDeleteAccount(string $user_name) : object {
    ...
    {
      echo '[Failed] userDeleteAccount(string $user_name)' .'「管理者に問い合わせください」' .'<br>';
      exit;
    }
    return $stmt;
  }
  ...
  */
  public function displayUser(string $user_name) :? array {
    ...
    {
      echo '[Failed] displayUser(string $user_name)' .'「管理者に問い合わせください」' .'<br>';
      exit;
    }
    return $this->table;
  }
